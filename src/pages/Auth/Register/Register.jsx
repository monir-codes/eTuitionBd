...
import {
  ...
  Zap,
  UploadCloud,
  Eye,       // 🚀 পাসওয়ার্ড ভিজিবিলিটি টগলের জন্য ইম্পোর্ট ভাই
  EyeOff     // 🚀 পাসওয়ার্ড ভিজিবিলিটি টগলের জন্য ইম্পোর্ট ভাই
} from "lucide-react";
...
const Register = () => {
  ...
  // ফাইল সিলেক্ট হয়েছে কি না তা মোবাইলে লাইভ ট্র্যাক করার জন্য ওয়াচিং
      ...
      >
        ...
        <div className="lg:col-span-7 p-6 sm:p-10 lg:p-12 w-full">
            ...
            <div>
              <div className="relative">
                ...
                <input
                  ...
                  type={showPassword ? "text" : "password"} // 🎯 ফিক্স: ভিজিবিলিটি স্টেট অনুযায়ী ইনপুট টাইপ ডাইনামিক লক ভাই
                  placeholder="Password"
                  className={`w-full pl-12 pr-12 h-12 sm:h-14 bg-slate-50 border-none rounded-xl sm:rounded-2xl font-bold text-sm text-slate-700 placeholder-slate-400 focus:ring-2 outline-none transition-all ${
                    errors.password
                      ? "ring-2 ring-red-200"
                      : "focus:ring-[#40bfff]/20"
                  }`}
                ...
                <div className="flex items-center gap-3 px-4 font-bold text-xs sm:text-sm text-slate-500 group-hover/file:text-[#40bfff] transition-colors max-w-full">
                  {selectedPhotoFile && selectedPhotoFile[0] ? (
                    ...
                    <>
                      <UploadCloud
                        size={18}
                        className="text-slate-400 group-hover/file:text-[#40bfff]"
                      />
          ...
          <p className="text-center mt-6 sm:mt-8 font-bold text-xs sm:text-sm text-slate-400">
            ...
            <Link
              to="/login"
              className="text-[#40bfff] hover:underline font-black"
            >
              Login
            </Link>
          </p>
